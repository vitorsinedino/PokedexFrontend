            ...
            <figure className={`card card--${this.state.type}`}>
                ...
                <figcaption className="card__caption">
                    ...
                    <table className="card__stats">
                        ...
                        <tr>
                            <th>HP</th>
                            <td>{this.state.stats5.base_stat}</td>
                        </tr>
                        <tr>
                            <th>Attack</th>
                            <td>{this.state.stats4.base_stat}</td>
                        </tr>

                        <tr>
                            <th>Defense</th>
                            <td>{this.state.stats3.base_stat}</td>
                        </tr>

                        <tr>
                            <th>Special Attack</th>
                            <td>{this.state.stats2.base_stat}</td>
                        </tr>
                        <tr>
                            <th>Special Defense</th>
                            <td>{this.state.stats1.base_stat}</td>
                        </tr>
                        <tr>
                            <th>Speed</th>
                            <td>{this.state.stats0.base_stat}</td>
                        </tr>
                        </tbody>
                    </table>
